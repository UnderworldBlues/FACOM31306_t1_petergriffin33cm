public class EstudanteGraduacao extends Estudante {
    ...
    public void print(boolean mesmaLinha) {
        ...
        if (mesmaLinha) {
            System.out.println("(ESTUDANTE GRADUAÇÃO) Nome: " + getNome() + "; Endereço: " + getEndereco() + "; Titulo TCC: " + getTituloTCC());
        } else {
            System.out.println("<< ESTUDANTE GRADUAÇÃO >>");
            System.out.println("Nome: " + getNome());
            System.out.println("Endereço: " + getEndereco());
            System.out.println("Titulo TCC: " + getTituloTCC());
        }
