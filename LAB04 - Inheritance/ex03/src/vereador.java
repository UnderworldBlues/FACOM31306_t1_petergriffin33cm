public class vereador extends candidato{
    ...
    public vereador(Candidato c, String numeroVereador, String bairro) {
        super(c.getNomeCompleto(), c.getDataNascimento(), c.getGenero(), c.getTotalBens(), c.getCandidatoReeleicao(), c.getNumeroPartido());
        this.numeroVereador = numeroVereador;
        this.bairro = bairro;
    }
